# Generated by Django 3.2.8 on 2022-02-10 14:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Manager', 'Manager'), ('TL', 'TL'), ('Admin', 'Admin'), ('Agent', 'Agent'), ('SuperAdmin', 'SuperAdmin')], default=False, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('new_tickets_status', models.CharField(blank=True, default='newtickets', max_length=50, null=True)),
                ('assign_tickets_status', models.CharField(blank=True, max_length=50, null=True)),
                ('assign_tickets_date', models.DateField(blank=True, null=True)),
                ('pending_tickets_status', models.CharField(blank=True, max_length=50, null=True)),
